              ...
              <TableBody>
                {visibleLeads.map((lead: any, i: any) => (
                  <TableRow key={i} className={`${lead.progenicsReportReleaseDate ? 'bg-green-100 dark:bg-green-900/30' : 'bg-yellow-50 dark:bg-yellow-900/20'} hover:bg-opacity-75 dark:hover:bg-opacity-75 cursor-pointer`}>
                    ...
                    {processMasterColumnPrefs.isColumnVisible('clinicianResearcherName') && <TableCell className="whitespace-nowrap py-1">{lead.clinicianResearcherName || lead.referredDoctor || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('specialty') && <TableCell className="whitespace-nowrap py-1">{lead.specialty || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('clinicianResearcherEmail') && <TableCell className="whitespace-nowrap py-1">{lead.clinicianResearcherEmail || lead.email || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('clinicianResearcherPhone') && <TableCell className="whitespace-nowrap py-1">{lead.clinicianResearcherPhone || lead.phone || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('clinicianResearcherAddress') && <TableCell className="whitespace-nowrap py-1">{lead.clinicianResearcherAddress || lead.clinicianAddress || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('patientClientName') && <TableCell className="whitespace-nowrap py-1">{lead.patientClientName || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('age') && <TableCell className="whitespace-nowrap py-1">{lead.age || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('gender') && <TableCell className="whitespace-nowrap py-1">{lead.gender || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('patientClientEmail') && <TableCell className="whitespace-nowrap py-1">{lead.patientClientEmail || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('patientClientPhone') && <TableCell className="whitespace-nowrap py-1">{lead.patientClientPhone || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('patientClientAddress') && <TableCell className="whitespace-nowrap py-1">{lead.patientClientAddress || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('sampleCollectionDate') && <TableCell className="whitespace-nowrap py-1">{lead.sampleCollectionDate ? new Date(lead.sampleCollectionDate).toLocaleDateString() : '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('sampleReceivedDate') && <TableCell className="whitespace-nowrap py-1">{lead.sampleReceivedDate ? new Date(lead.sampleReceivedDate).toLocaleDateString() : '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('serviceName') && <TableCell className="whitespace-nowrap py-1">{lead.serviceName || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('sampleType') && <TableCell className="whitespace-nowrap py-1">{lead.sampleType || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('noOfSamples') && <TableCell className="whitespace-nowrap py-1">{lead.noOfSamples || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('tat') && <TableCell className="whitespace-nowrap py-1">{lead.tat || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('salesResponsiblePerson') && <TableCell className="whitespace-nowrap py-1">{lead.salesResponsiblePerson || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('progenicsTrf') && <TableCell className="whitespace-nowrap py-1">{lead.progenicsTrf ? <PDFViewer pdfUrl={lead.progenicsTrf} fileName="Progenics_TRF.pdf" /> : '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('thirdPartyTrf') && <TableCell className="whitespace-nowrap py-1">{lead.thirdPartyTrf || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('progenicsReport') && <TableCell className="whitespace-nowrap py-1">{lead.progenicsReport || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('sampleSentToThirdPartyDate') && <TableCell className="whitespace-nowrap py-1">{lead.sampleSentToThirdPartyDate ? new Date(lead.sampleSentToThirdPartyDate).toLocaleDateString() : '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('thirdPartyName') && <TableCell className="whitespace-nowrap py-1">{lead.thirdPartyName || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('thirdPartyReport') && <TableCell className="whitespace-nowrap py-1">{lead.thirdPartyReport || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('resultsRawDataReceivedFromThirdPartyDate') && <TableCell className="whitespace-nowrap py-1">{lead.resultsRawDataReceivedFromThirdPartyDate ? new Date(lead.resultsRawDataReceivedFromThirdPartyDate).toLocaleDateString() : '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('logisticStatus') && <TableCell className="whitespace-nowrap py-1">{lead.logisticStatus || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('financeStatus') && <TableCell className="whitespace-nowrap py-1">{lead.financeStatus || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('labProcessStatus') && <TableCell className="whitespace-nowrap py-1">{lead.labProcessStatus || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('bioinformaticsStatus') && <TableCell className="whitespace-nowrap py-1">{lead.bioinformaticsStatus || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('nutritionalManagementStatus') && <TableCell className="whitespace-nowrap py-1">{lead.nutritionalManagementStatus || '-'}</TableCell>}
                    {processMasterColumnPrefs.isColumnVisible('progenicsReportReleaseDate') && <TableCell className="whitespace-nowrap py-1">{lead.progenicsReportReleaseDate ? new Date(lead.progenicsReportReleaseDate).toLocaleDateString() : '-'}</TableCell>}
                    ...
                    {processMasterColumnPrefs.isColumnVisible('actions') && <TableCell className="actions-column py-1">
                      <div className="flex gap-2">
                        ...
                        <Button variant="ghost" className="h-7 w-7 p-1" onClick={() => handleDelete(lead.id)}>
